...
class GroupBy(Scene):
    def construct(self):
        ...
        # -----Title-----
        title = MarkupText('GroupBy With Aggregation', color=GOLD).scale(0.7).shift(3.5 * UP)
        ...
        console_2 = create_console(13.9, 0.6, 0.6 * DOWN, DARK_GREY, 'df.groupby("Title")["Salary"].mean()')
