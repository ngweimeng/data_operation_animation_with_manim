...
class Aggregate(Scene):
    def construct(self):
        ...
        # -----Title-----
        title = MarkupText('Aggregate Functions: Mean', color=GOLD).scale(0.7).shift(3.5 * UP)
        ...
        # -----Mean of Salary-----
        subtitle_2 = create_subtitle("Next, we calculate the mean of the 'Salary' column.")
        console_2 = create_console(13.9, 0.6, 0.6 * DOWN, DARK_GREY, 'df["Salary"].mean()')
        ...
        # Display the mean of the Salary column
        mean_salary = "87000"  # Pre-calculated mean of the Salary column
        resultant_headers = ["Result:"]
        resultant_data = [[mean_salary]]
