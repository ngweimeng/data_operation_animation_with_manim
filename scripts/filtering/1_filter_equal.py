...
class Filtering(Scene):
    def construct(self):
       ...
       # -----Functions-----
        ...
        # -----Title-----
        title = MarkupText('Filtering with Comparison Operator: Equal (==)', color=GOLD).scale(0.7).shift(3.5 * UP)
        ...
        subtitle_2 = create_subtitle("Next, we filter the DataFrame to show only employees with the title 'Engineer'.")
