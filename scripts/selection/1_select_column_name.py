...
class Select(Scene):
    def construct(self):
        ...
        # -----Title-----
        title = MarkupText('Selecting Columns by Name', color=GOLD).scale(0.7).shift(3.5 * UP)
        ...
        # -----Select Columns "Name" and "Title"-----
        subtitle_2 = create_subtitle("Next, we select the columns 'Name' and 'Title'.")
        console_2 = create_console(13.9, 0.6, 0.6 * DOWN, DARK_GREY, 'df[["Name", "Title"]]')
        ...
        resultant_dataframe_rows = create_dataframe(resultant_headers, resultant_data, -1.2 * UP)
