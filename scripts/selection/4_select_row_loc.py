...
class Select(Scene):
    def construct(self):
        ...
        # -----Title-----
        title = MarkupText('Selecting Rows with ".loc"', color=GOLD).scale(0.7).shift(3.5 * UP)
        ...
        # -----Select Rows by Name-----
        subtitle_2 = create_subtitle("Next, we select the rows for 'Alice' and 'Diana'.")
        console_2 = create_console(13.9, 0.6, 0.6 * DOWN, DARK_GREY, 'df.loc[["Alice", "Diana"]]')
