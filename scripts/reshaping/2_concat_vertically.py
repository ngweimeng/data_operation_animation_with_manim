...
class concat(Scene):
    def construct(self):
        ...
        # -----Title-----
        title = MarkupText('Concat Vertically', color=GOLD).scale(0.7).shift(3.5 * UP)
        ...
        self.play(FadeOut(subtitle_1))
         ...
         # -----Append Columns-----
        subtitle_2 = create_subtitle("Next, we concatenate the two DataFrames vertically using the concat function.")
